...
const faltantes = [];
if (!token)
    faltantes.push("TOKEN (o DISCORD_TOKEN)");
if (!clientId)
    faltantes.push("CLIENT_ID (o APPLICATION_ID)");
if (!guildId)
    faltantes.push("GUILD_ID (o SERVER_ID)");
if (!mongoUri)
    faltantes.push("MONGO_URI (o MONGODB_URI)");
