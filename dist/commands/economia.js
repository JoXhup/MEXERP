...
import { handleEconomiaGeneral, handleRanking, handleEcoAdmin, } from "../handlers/economyHandler.js";
const data = new SlashCommandBuilder()
    ...
    .setRequired(true)
    .addChoices({ name: "💵 Dinero (Efectivo)", value: "dinero" }, { name: "🏦 Banco", value: "banco" }, { name: "🕶️ Dinero Negro (Ilegal)", value: "ilegal" }))
