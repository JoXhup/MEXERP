 ...
 */
export async function sendErlcApiErrorContainer(target, cmdName) {
    ...
    const container = new ContainerBuilder()
        ...
        .addTextDisplayComponents(new TextDisplayBuilder().setContent(`# API / Not Found\n\`:${cmdName}\` · Comando Externo ERLC`))
        ...
        .addSeparatorComponents(new SeparatorBuilder().setSpacing(SeparatorSpacingSize.Small).setDivider(true))
        .addTextDisplayComponents(new TextDisplayBuilder().setContent("-# Sonora System · ERLC Integration"));
