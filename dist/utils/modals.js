import { LabelBuilder, ModalBuilder, TextInputBuilder, TextInputStyle, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, } from "discord.js";
// ─── REGLA MODAL V2 ────────────────────────────────────────────────────────────
...
export function buildCategoryModal(cat) {
    const modal = new ModalBuilder()
        .setCustomId(`ticket:modal:${cat.id}`)
        .setTitle(cat.modalTitle);
    const labels = cat.fields.slice(0, 5).map(field => {
...
// ─── MODAL V2: REPORTAR ───────────────────────────────────────────────────────
export function buildReportarModal() {
    const modal = new ModalBuilder()
    ...
    const tipoSelect = new StringSelectMenuBuilder()
        ...
        .addOptions(new StringSelectMenuOptionBuilder().setLabel("Capturas de pantalla").setValue("capturas"), new StringSelectMenuOptionBuilder().setLabel("Video o grabacion").setValue("video"), new StringSelectMenuOptionBuilder().setLabel("Testigos presenciales").setValue("testigos"), new StringSelectMenuOptionBuilder().setLabel("Logs del servidor").setValue("logs"), new StringSelectMenuOptionBuilder().setLabel("Sin pruebas").setValue("sin_pruebas"));
...
export function buildReportarStaffModal() {
    const modal = new ModalBuilder()
    ...
    const gravSelect = new StringSelectMenuBuilder()
        ...
        .setMinValues(1).setMaxValues(1)
        .addOptions(new StringSelectMenuOptionBuilder().setLabel("Leve — mal comportamiento puntual").setValue("leve"), new StringSelectMenuOptionBuilder().setLabel("Moderado — abuso de permisos").setValue("moderado"), new StringSelectMenuOptionBuilder().setLabel("Grave — acoso o discriminacion").setValue("grave"), new StringSelectMenuOptionBuilder().setLabel("Muy grave — corrupcion activa").setValue("muy_grave"));
    const l1 = new LabelBuilder()
...
export function buildPeticionRolModal() {
    const modal = new ModalBuilder()
...
export function buildComprasRealesModal() {
    const modal = new ModalBuilder()
    ...
    const metodoSelect = new StringSelectMenuBuilder()
        ...
        .setMinValues(1).setMaxValues(1)
        .addOptions(new StringSelectMenuOptionBuilder().setLabel("Robux").setValue("robux"), new StringSelectMenuOptionBuilder().setLabel("PayPal").setValue("paypal"), new StringSelectMenuOptionBuilder().setLabel("Transferencia bancaria").setValue("banco"), new StringSelectMenuOptionBuilder().setLabel("Tarjeta de credito/debito").setValue("tarjeta"), new StringSelectMenuOptionBuilder().setLabel("Otro metodo").setValue("otro"));
    const l1 = new LabelBuilder()
...
export function buildEmpresaFaccionModal() {
    const modal = new ModalBuilder()
    ...
    const tipoSelect = new StringSelectMenuBuilder()
        ...
        .setMinValues(1).setMaxValues(1)
        .addOptions(new StringSelectMenuOptionBuilder().setLabel("Empresa legal").setValue("empresa"), new StringSelectMenuOptionBuilder().setLabel("Faccion / Banda").setValue("faccion"), new StringSelectMenuOptionBuilder().setLabel("Cartel").setValue("cartel"), new StringSelectMenuOptionBuilder().setLabel("Clan / Grupo").setValue("clan"), new StringSelectMenuOptionBuilder().setLabel("Organizacion independiente").setValue("independiente"));
    const l1 = new LabelBuilder()
...
export function buildCloseTicketModal(channelId) {
    const modal = new ModalBuilder()
...
function rawTextLabel(label, customId, style, placeholder, required, minLength, maxLength) {
    return {
        type: 18,
        label,
        component: {
...
function rawFileLabel(label, description, customId, required = false) {
    return {
        type: 18,
        label,
        description,
