      ...
      try {
        ...
        if (logChannel && logChannel.isTextBased()) {
          const logEmbed = new EmbedBuilder()
            ...
            .addFields(
              { name: "Usuario Contratado", value: `<@${targetUser.id}> (@${targetUser.username})`, inline: true },
              { name: "Contratado Por", value: `<@${interaction.user.id}> (@${interaction.user.username})`, inline: true },
              { name: "Rango Asignado", value: "**Trial Mod.**", inline: true },
